...
class QuantumCNN(nn.Module):
    def __init__(self):
        ...
        # Convolutional layers with Batch Normalization Conv32Conv64FC256FC25Q5
        ...
        self.fc2 = nn.Linear(256, 25)  # Output size matches quantum layer input

        # Quantum layers using PennyLane (5 parallel circuits)
        ...
        # Output layer
        self.fc_output = nn.Linear(25, 10)  # 10 classes for CIFAR-10
    ...
    def forward(self, x):
        ...
        # Split the output into five parts for the quantum layers
...
log_file = os.path.join(output_dir, "cifarconv2_output.txt")
...
model_path = os.path.join(output_dir, "cifar2conv.pth")
